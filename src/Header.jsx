...
export default function Header() {
  ...
  return (
    <header className="navigation-case">
      <img
        className={`${gate ? "hidde" : ""}`}
        src="./images/logo-bookmark.svg"
        alt="bookmark logo"
      />
      <button
        onClick={() => setGate(true)}
        className={gate ? "hidde" : "only-mobile"}>
        <img src="./images/icon-hamburger.svg" alt="open menu button" />
      </button>
      <nav className={`navigation ${gate ? "move-hamburger" : ""}`}>
        ...
        <div className="only-mobile">
          ...
          <li>
            <button className="btn-red std nav-log">LOGIN</button>
          </li>
        </ul>
        {gate && <PlatformLink />}
      </nav>
